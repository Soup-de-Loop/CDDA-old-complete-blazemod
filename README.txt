...
Use instead of the new Blaze Industries mod in latest experimentals if continuing an with blazemod in it. Uninstall any turrets and turret-frames from your vehicles before updating to use this version to avoid segfault crashes.
Do not use with the other add-on versions of legacy mods from my repos, as they are modified for the new Blaze Industries.
